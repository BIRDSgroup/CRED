...
def compute_influences(sentence, clf, tokenizer, biobert, get_specific_token_embeddings):
    ...
    for perturbed in perturbed_sentences:
        ...
        influence=(min(original_prediction+perturbed_prediction, 1))*(original_confidence-perturbed_confidence)
...
def save_word_importance_to_file(word_importance, row, filename='word_imp_sc_new_CDR_trained_sample_abstract_xgb.tsv'):
